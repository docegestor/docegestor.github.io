...
<html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="stylesheet" href="/assets/site-enhancements.css">
...
<section class="card"><h2>Ingredientes</h2><ul>{ingredients}</ul></section><section><h2>Modo de preparo</h2><ol>{steps}</ol></section>{f'<section class="card"><h2>Dicas</h2><ul>{tips}</ul></section>' if tips else ''}{source}<p class="meta">Publicado em {published}</p></main><footer>Receitas autorais e conteúdo editorial do DoceGestor.</footer><script src="/assets/site-enhancements.js" defer></script></body></html>'''
